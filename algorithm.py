...
# #generate vertexes for each truck
# vertex_1 = graph.Vertex("1") # 1, "CITIZEN KANE", 1941, 25.00, Salt Lake City, Utah
# g.add_vertex(vertex_1)
# vertex_2 = graph.Vertex("2") # 2, "CASABLANCA", 1942, 25.00, Helena, Montana
# g.add_vertex(vertex_2)
# vertex_3 = graph.Vertex("3") # 3, "THE GODFATHER", 1972, 10.00, Santa Fe, New Mexico
# g.add_vertex(vertex_3) 
# vertex_4 = graph.Vertex("4") # 4, "GONE WITH THE WIND", 1939, 10.00, Austin, Texas
# g.add_vertex(vertex_4) 
# vertex_5 = graph.Vertex("5") # 5, "LAWRENCE OF ARABIA", 1962, 10.00, Lincoln, Nebraska
# g.add_vertex(vertex_5) 
# vertex_6 = graph.Vertex("6") # 6, "THE WIZARD OF OZ", 1939, 10.00, Madison, Wisconsin
# g.add_vertex(vertex_6) 
# vertex_7 = graph.Vertex("7") # 7, "THE GRADUATE", 1967, 5.00, New York, New York
# g.add_vertex(vertex_7) 
# vertex_8 = graph.Vertex("8") # 8, "ON THE WATERFRONT", 1954, 5.00, Columbus, Ohio
# g.add_vertex(vertex_8) 
# vertex_9 = graph.Vertex("9") # 9, "SCHINDLER'S LIST", 1993, 5.00, Raleigh, North Carolina
# g.add_vertex(vertex_9) 
# vertex_10 = graph.Vertex("10") # 10, "SINGIN' IN THE RAIN", 1952, 5.00, Orlando, Florida
# g.add_vertex(vertex_10) 
# vertex_11 = graph.Vertex("11") # 11, "STAR WARS", 1977, 1.00, Montgomery, Alabama
